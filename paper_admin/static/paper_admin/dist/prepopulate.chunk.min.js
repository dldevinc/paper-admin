(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["prepopulate"],{

/***/ "./paper_admin/static/paper_admin/src/js/components/prepopulate/prepopulate.js":
/*!*************************************************************************************!*\
  !*** ./paper_admin/static/paper_admin/src/js/components/prepopulate/prepopulate.js ***!
  \*************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _urlify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./urlify */ "./paper_admin/static/paper_admin/src/js/components/prepopulate/urlify.js");
...
function prepopulate(field, dependencies, maxLength, allowUnicode) {
  const populate = function populate() {
    ...
    field.value = Object(_urlify__WEBPACK_IMPORTED_MODULE_2__["default"])(values.join(' '), maxLength, allowUnicode);
  };
...
if (window.django_prepopulated_fields && window.django_prepopulated_fields.length) {
  Object(when_dom_ready__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
    for (var _iterator = _createForOfIteratorHelperLoose(window.django_prepopulated_fields), _step; !(_step = _iterator()).done;) {
  ...
  _emitters__WEBPACK_IMPORTED_MODULE_1__["default"].inlines.on('added', function (row, prefix) {
    row.querySelectorAll('.prepopulated-field').forEach(function (field) {
      ...
      if (dependencies.length) {
        prepopulate(field, dependencies, Number(field.dataset.maxLength), Boolean(Number(field.dataset.allowUnicode)));
      }
    });
  });
}
...
/***/ "./paper_admin/static/paper_admin/src/js/components/prepopulate/urlify.js":
/*!********************************************************************************!*\
  !*** ./paper_admin/static/paper_admin/src/js/components/prepopulate/urlify.js ***!
  \********************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return urlify; });
...
const LATIN_MAP = {
  ...
  'ჰ': 'h'
      ...
      ALL_DOWNCODE_MAPS = [LATIN_MAP, LATIN_SYMBOLS_MAP, GREEK_MAP, TURKISH_MAP, ROMANIAN_MAP, RUSSIAN_MAP, UKRAINIAN_MAP, CZECH_MAP, SLOVAK_MAP, POLISH_MAP, LATVIAN_MAP, ARABIC_MAP, LITHUANIAN_MAP, SERBIAN_MAP, AZERBAIJANI_MAP, GEORGIAN_MAP];
const Downcoder = {
...
function urlify(s, num_chars, allowUnicode) {
  ...
  const hasUnicodeChars = /[^\u0000-\u007f]/.test(s); // Remove English words only if the string contains ASCII (English)
  // characters.

  if (!hasUnicodeChars) {
    const removeList = ["a", "an", "as", "at", "before", "but", "by", "for", "from", "is", "in", "into", "like", "of", "off", "on", "onto", "per", "since", "than", "the", "this", "that", "to", "up", "via", "with"];
  ...
  if (allowUnicode) {
    ...
    s = xregexp__WEBPACK_IMPORTED_MODULE_0___default.a.replace(s, xregexp__WEBPACK_IMPORTED_MODULE_0___default()('[^-_\\p{L}\\p{N}\\s]', 'g'), '');
  } else {
